    ...
    return (
        <section id={'Project_Cards'} className={'flex flex-col justify-center scroll-mt-28 py-20 md:py-28'}>
            ...
            <div className={'flex flex-row justify-evenly items-center w-full gap-4 pt-4'}>
                <HashLink to={'/project#JPL_Introduction'} className="basis-1/2 rounded-2xl border border-[var(--border)] bg-[var(--bg)] p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-lg">
                ...
                <HashLink to={'/project#Web_Introduction'} className="basis-1/2 rounded-2xl border border-[var(--border)] bg-[var(--bg)] p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-lg">
                    <h4 className="text-xl font-semibold text-[var(--text-h)]">
                        Full Stack Website
                    </h4>
                    <p className="mt-3 text-[var(--text)] leading-relaxed">
